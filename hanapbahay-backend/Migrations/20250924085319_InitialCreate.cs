    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LandlordRatings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LandlordRatings_AspNetUsers_LandlordId",
                        column: x => x.LandlordId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LandlordRatings_AspNetUsers_RenterId",
                        column: x => x.RenterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZipCode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TargetLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Landmark = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MonthlyPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MaxPersons = table.Column<byte>(type: "tinyint", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LandlordRatings_LandlordId",
                table: "LandlordRatings",
                column: "LandlordId");

            migrationBuilder.CreateIndex(
                name: "IX_LandlordRatings_RenterId_LandlordId",
                table: "LandlordRatings",
                columns: new[] { "RenterId", "LandlordId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_Province_City_ZipCode",
                table: "Properties",
                columns: new[] { "Province", "City", "ZipCode" });

            migrationBuilder.CreateIndex(
                name: "IX_Properties_Status_City_PropertyType",
                table: "Properties",
                columns: new[] { "Status", "City", "PropertyType" });
